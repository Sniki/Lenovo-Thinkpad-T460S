// Universal Battery Status SSDT for Lenovo ThinkPads (BenBender)

DefinitionBlock ("", "SSDT", 2, "T460S", "BATX", 0x00010000)
{
    // Please ensure that your LPC bus-device is available at \_SB.PCI0.LPC (check your DSDT). 
    ...
    Scope (\_SB.PCI0.LPC.EC)
    {
        ...
        Device (BATX)
        {
            ...
            Method (GBIX, 2, NotSerialized)
            {
                ...
                // cycle count
                Arg1 [0x08] = SBCC /* \_SB_.PCI0.LPC.EC__.BATX.SBCC */

                // needs conversion?
                Local7 = SBBM /* \_SB_.PCI0.LPC.EC__.BATX.SBBM */
                Local7 >>= 0x0F
                ...
                Else
                {
                    Local1 = SBFC /* \_SB_.PCI0.LPC.EC__.BATX.SBFC */
                }
                ...
                Else
                {
                    Local0 = SBDC /* \_SB_.PCI0.LPC.EC__.BATX.SBDC */
                }
                ...
                // Design voltage
                Arg1 [0x05] = SBDV /* \_SB_.PCI0.LPC.EC__.BATX.SBDV */

                // Serial Number
                Arg1 [0x11] = SBSN /* \_SB_.PCI0.LPC.EC__.BATX.SBSN */
                ...
                Arg1 [0x10] = SBDN /* \_SB_.PCI0.LPC.EC__.BATX.SBDN */
                ...
                Arg1 [0x12] = SBCH /* \_SB_.PCI0.LPC.EC__.BATX.SBCH */
                ...
                Arg1 [0x13] = SBMN /* \_SB_.PCI0.LPC.EC__.BATX.SBMN */
            ...
            Method (GBST, 2, NotSerialized)
            {
                ...
                // 
                Local2 = SBRC /* \_SB_.PCI0.LPC.EC__.BATX.SBRC */
                ...
                Local1 = SBAC /* \_SB_.PCI0.LPC.EC__.BATX.SBAC */
                ...
                // Get voltage
                Local3 = SBVO /* \_SB_.PCI0.LPC.EC__.BATX.SBVO */
            ...
            If (BBIS)
            {
                ...
                */
                Method (CBIS, 0, NotSerialized)
                {
                    ...
                    Local6 = ToDecimalString (SBSN) /* \_SB_.PCI0.LPC.EC__.BATX.SBSN */
